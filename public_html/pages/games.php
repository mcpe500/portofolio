    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative max-w-xl mx-auto mb-12">
            ...
            <input type="text" 
                   ...
                   placeholder="Search games (e.g., 'uno', 'multiplayer', 'cards')...">
        </div>
            ...
            <?php else: ?>
                <?php foreach ($games as $key => $game): ?>
                    <a href="/<?= htmlspecialchars($game["route"]) ?>" 
                       ...
                       data-desc="<?= htmlspecialchars(strtolower($game["description"])) ?>"
        ...
        <div id="no-results" class="hidden text-center py-12">
            ...
            <h3 class="text-xl font-medium text-gray-900 dark:text-white">No games found</h3>
